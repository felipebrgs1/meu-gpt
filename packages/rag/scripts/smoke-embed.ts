...
async function main() {
  ...
  const chunks = splitText(
    SAMPLE + "\nDoc sobre gatos, cachorros, RAG e Cloudflare. ".repeat(20),
    1200,
    150,
  ).slice(0, 20);
  ...
  console.log(
    "OK: 1024 + float consistente. Pode criar índice: npx wrangler vectorize create meu-gpt --dimensions=1024 --metric=cosine",
  );
}
